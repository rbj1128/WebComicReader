...
public class Main extends Activity {
    ...
    boolean showBaldo = true;
    boolean showBC = true;
    boolean showBleachers = true;
    boolean showFoxtrot = false;
    boolean showExplosim = true;
    boolean showHagar = true;
    boolean showRhymes = true;
    boolean showPearls = true;
    boolean showXKCD = true;
    boolean showZits = true;
    boolean showWashPost = true;
        ...
        if (showBaldo) {
            ...
            this.baldoBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/baldo/"));
        ...
        if (showBC) {
            ...
            this.bCBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/bc/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showBleachers) {
            ...
            this.bleachersBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/in-the-bleachers/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showFoxtrot) {
            ...
            this.foxTrotBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/fox-trot/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showExplosim) {
            ...
            this.explosimBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("http://www.explosm.net/comics/new/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showHagar) {
            ...
            this.hagarBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/hagar-the-horrible/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showRhymes) {
            ...
            this.orangeBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/rhymes-with-orange/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showPearls) {
            ...
            this.pearlsBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/pearls-before-swine/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showXKCD) {
            ...
            this.xkcdBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("http://xkcd.com"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showZits) {
            ...
            this.zitsBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/zits/"));
                    Main.this.startActivity(intent);
                }
            });
        ...
        if (showWashPost) {
            ...
            this.washPostBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View param1View) {
                    ...
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse("https://www.washingtonpost.com/entertainment/comics/"));
                    Main.this.startActivity(intent);
                }
            });
